    ...
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm mt-1" style={{ color: "var(--color-slate-400)" }}>Create your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl p-8 border space-y-4"
          ...
          <div>
            <label className="block text-sm mb-1.5" style={{ color: "var(--color-slate-300)" }}>Full name</label>
            <input
              type="text"
              value={name}
              ...
              style={{ background: "var(--color-slate-800)", color: "white", border: "1px solid var(--color-slate-700)" }}
            />
          </div>
          ...
          <p className="text-center text-sm" style={{ color: "var(--color-slate-400)" }}>
            ...
            <Link href="/auth/login" className="hover:underline" style={{ color: "#818cf8" }}>
              Sign in
            </Link>
          </p>
        </form>
